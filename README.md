...
## Conclusion
This project demonstrates how exploratory and comparative analytics can deliver significant strategic value in a complex, regulated financial environment. By consolidating fragmented public APP fraud statistics into a coherent dataset, the analysis challenges volume led perceptions of risk and highlights severity as a more appropriate driver of prioritisation. Crucially, the work illustrates that impactful data science does not always require complex predictive modelling, where data is aggregated and decisions are strategic, interpretability, transparency and alignment with business objectives are paramount. The project therefore reflects professional data science practice by balancing analytical rigour with ethical responsibility and practical relevance.
